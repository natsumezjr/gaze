...
def main():
    ...
    parser.add_argument("--area-ratio-min", type=float, default=0.10, help="棋盘面积占比阈值")
    parser.add_argument("--blur-var-min", type=float, default=110.0, help="清晰度阈值（Laplacian 方差）")
