...
const calibrationColors = [
    { bg: '#FF8A95', fg: '#FF6B7A' }, // 温柔珊瑚红
    { bg: '#8FE1A2', fg: '#6FCF97' }, // 清新薄荷绿
    { bg: '#74B9FF', fg: '#5DADE2' }, // 优雅天蓝色
    { bg: '#A29BFE', fg: '#8B7ED8' }, // 梦幻薰衣草紫
    { bg: '#FDCB6E', fg: '#F39C12' }, // 温暖金橙色
    { bg: '#E17055', fg: '#D63031' }, // 温润土橙色
    { bg: '#81ECEC', fg: '#00CEC9' }, // 清澈青绿色
    { bg: '#FD79A8', fg: '#E84393' }, // 甜美粉红色
    { bg: '#FDAC41', fg: '#E17055' }  // 活力橘色
];
